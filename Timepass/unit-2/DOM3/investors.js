let investors = [
  ...
  investors.map(function(item){
    let card = document.createElement("div");

    let pic = document.createElement("img");
    pic.setAttribute("src",item.image);
    pic.setAttribute("class","clpic");
    card.append(pic);
    ...
    role.setAttribute("class","clrole");
    card.append(role);

    let logo = document.createElement("img");
    logo.setAttribute("src",item.companyLogo);
    logo.setAttribute("class","cllogo");
    card.append(logo);
